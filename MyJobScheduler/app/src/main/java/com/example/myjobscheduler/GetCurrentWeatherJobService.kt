...
class GetCurrentWeatherJobService: JobService() {
    ...
    companion object{
        ...
        internal const val CITY = "Payakumbuh"

        internal const val APP_ID = "40caa3b0df2d88667ee3a5da903a9fe3"
    }
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(statusCode: Int, headers: Array<Header>, responseBody: ByteArray) {
                ...
                try {
                    ...
                    showNotification(applicationContext, title, message, notidId)
    ...
    private fun showNotification(context: Context, title: String, message: String, notidId: Int) {
        ...
        notificationManagerCompat.notify(notidId, notification)
    }
}